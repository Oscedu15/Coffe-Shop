    ...
    <section className="py-12 xl:py-0 xl:h-[90vh] xl:w-screen" id="explore">
      <div className="container mx-auto xl:w-full xl:h-full flex xl:justify-center xl:items-center">
        <div className=" w-full flex flex-col lg:flex-row gap-12 xl:gap-20">
          ...
          text-center xl:text-left gap-12 xl:gap-0 max-w-[25rem] mx-auto xl:max-w-none xl:mx-0"
          >
            {/* item 1 */}
            <div className="relative flex items-start">
              <div className="xl:max-w-[26.25rem] xl:text-right xl:flex xl:flex-col xl:items-end">
          ...
          <div className="hidden xl:flex justify-center">
            <div className="relative w-[20.125rem] h-[36.25rem]">
              <Image
          ...
          >
            {/* item 3 */}
            <div className="relative flex items-start">
              <div className="xl:max-w-[26.25rem] xl:text-left xl:flex xl:flex-col xl:items-start">
                <div className="mb-6 flex justify-center items-center">
                  <Image
